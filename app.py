# --- 2. หน้าสินค้าที่มีปัญหา (คงเหลือติดลบ) ---
    ...
    if not df_all.empty and "คงเหลือ" in df_all.columns:
        ...
        if not df_negative.empty:
            ...
            st.download_button(
                label=f"📥 ดาวน์โหลด Excel ({report_title})",
